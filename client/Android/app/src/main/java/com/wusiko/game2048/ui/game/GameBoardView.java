...
//					e.printStackTrace();
	...
	private void MergeTile(@NotNull MergedTileLink link)
	{
		...
		GameTileView tileView = mTileViewsByIndex.get(indexOrigin);
		if (tileView == null)
		{
