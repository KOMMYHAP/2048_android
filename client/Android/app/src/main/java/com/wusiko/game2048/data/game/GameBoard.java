...
public class GameBoard {
    ...
    private GameTileFactory mGameTileFactory = new GameTileFactory(GameConfig.TILE_PROBABILITIES, mRandom);
    private GameTile[] mGameField;
    private List<GameTileLink> mTileLinks;
    ...
    public List<GameTileLink> GetGameTileLinks() {
        return Collections.unmodifiableList(mTileLinks);
    }
    ...
    private GameTile TryToCreateTile() {
        ...
        mTileLinks.add(GameTileLink.NewCreatedTile(tile));
        return tile;
    }
